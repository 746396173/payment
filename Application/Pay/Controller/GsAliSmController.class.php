...
class GsAliSmController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site . 'Pay_GsAliSm_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_GsAliSm_callbackurl.html'; //跳转通知
        $parameter = array(
            'code' => 'GsAliSm',       // 通道代码
            'title' => '怪兽支付宝扫码',      //通道名称
            'exchange' => 1,          // 金额比例
        ...
        //支付方式s
        $data['method'] = "syceepay.alipay.transfer";//支付宝转银行卡 syceepay.alipay.bank,支付宝转帐syceepay.alipay.transfer,微信syceepay.wechat.transfer
        //银行代码 可为空
        $data['bank_code'] = '';
        //交易金额
