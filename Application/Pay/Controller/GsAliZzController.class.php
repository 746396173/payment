...
class GsAliZzController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site . 'Pay_GsAliZz_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_GsAliZz_callbackurl.html'; //跳转通知
        $parameter = array(
            'code' => 'GsAliZz',       // 通道代码
            'title' => '怪兽支付宝转帐',      //通道名称
            'exchange' => 1,          // 金额比例
