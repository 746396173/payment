...
$pay_memberid = "10087";   //商户后台API管理获取
...
$Md5key = "4bcde7v1g0njf3w6og751jn9euudqob2";   //商户后台API管理获取
$tjurl = "http://vefutong.com/Pay_Index.html";   //提交地址
$pay_bankcode = "904"; //支付宝扫码  //商户后台通道费率页 获取银行编码
$native = array(
