...
<div class="pay_sure12">
    <div class="pay_sure12-main">
        ...
        <p>支付遇到问题？请联系 <span class="f12 blue">易付</span> 客服获得帮助。</p>
    </div>
</div>
<!--弹窗结束-->
<!--导航-->
...
<div class="w1080 PayMethod12" style="border-radius: 1em;">
    <div class="row">
        ...
        <ul>
            ...
            <input value="904" checked="checked" name="channel" id="zfb" type="radio">
...
<!--            </li></label>-->
           ...
           <label for="zfb_zk">
                <li class="pay_li" data_power_id="3000000071" data_product_id="3000000071">
                    <input value="929" name="channel" id="zfb_zk" type="radio">
